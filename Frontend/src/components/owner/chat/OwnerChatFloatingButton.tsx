...
import { MessageSquare, X, Minus, Users } from 'lucide-react';
import { useSocket } from '../../../hooks/useSocket';
import { chatService } from '../../../services/chatService';
import { useAuth } from '../../../contexts/authContext';
import OwnerChatInterface from './OwnerChatInterface';

const OwnerChatFloatingButton: React.FC = () => {
  const { user } = useAuth();
  ...
  // Don't show if user is not logged in or not owner
        ...
        >
          ...
          <div className="bg-blue-600 text-white px-4 py-3 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium">Chat với Khách hàng</span>
          ...
          {!isMinimized && (
            <div className="h-[556px] flex flex-col">
              <OwnerChatInterface className="h-full" />
            </div>
          )}
        </div>
      )}
...
export default OwnerChatFloatingButton;
